...
Describe "Module Pester functions help" -Tags "Help" {
    ...
    [String[]]$AccepteMissedHelpDescription = @('AfterAll', 'AfterEach', 'BeforeAll', 'BeforeEach', 'SafeGetCommand')

    [String[]]$AcceptMissedHelpParameters = @('Should')

    [String[]]$AcceptMissedHelpExamples = @('AfterAll', 'AfterEach', 'AfterEachFeature', 'AfterEachScenario', 'BeforeAll', 'BeforeEach', 'BeforeEachFeature', 'BeforeEachScenario', 'Invoke-Mock', 'Set-DynamicParameterValues', 'SafeGetCommand', 'Get-MockDynamicParameters', 'Should', 'In')
